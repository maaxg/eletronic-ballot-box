...
public class ControllerMainScreen {
    ...
    @FXML
    private void menuCandidato(ActionEvent e){ Main.candidatoScreen(stage); }
    @FXML
    private void menuPartido(ActionEvent e){ Main.partidosScrenn(stage).show();}
